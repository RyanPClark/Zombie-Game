...
public final class Initialize {
	...
	public static Terrain loadTerrain(float x, float z, String _backgroundTexture, String _rTexture, String _gTexture,
		...
		Terrain terrain = new Terrain(x, z, texturePack, blendMap, "Terrain/"+_heightmap);
	...
	protected static Gun loadGun(int weaponID){
		...
		Gun gun = new Gun(texturedGun, weaponID, "gun");
		GunLoader.loadGun(gun, weaponID);
	...
	public static Zombie newZombie (int type){
		...
		Zombie barn = new Zombie(texturedGunZ.get(type), new Vector3f(25, 0, 25), true, ZombieLoader.b_model_distances[type], ZombieLoader.healths[type], ZombieLoader.speeds[type]);
		barn.setEmitter(new ParticleEmitter(null, "BLOOD"));
