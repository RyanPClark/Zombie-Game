...
public class WaterFrameBuffers {
	...
	private static final int WATER_REFLECTION_RES = Statics.WATER_REFLECTION_RES;
	
    protected static final int REFRACTION_WIDTH = Display.getWidth();
    private static final int REFRACTION_HEIGHT = Display.getHeight();
    
    protected static final int REFLECTION_WIDTH = Display.getWidth()/WATER_REFLECTION_RES;
    private static final int REFLECTION_HEIGHT = Display.getHeight()/WATER_REFLECTION_RES;
